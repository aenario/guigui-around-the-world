...
module.exports = function(config) {
  ...
  config.set({
    ...
    files: [
      ...
      'app/scripts/vendor/angular-animate/angular-animate.js',
      'app/scripts/vendor/angular-cookies/angular-cookies.js',
      'app/scripts/vendor/angular-resource/angular-resource.js',
